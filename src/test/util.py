...
for f in (
    ...
    ('wally_descriptor_canonicalize', c_int, [c_char_p, POINTER(wally_map), c_uint, c_char_p_p]),
    ('wally_descriptor_get_checksum', c_int, [c_char_p, POINTER(wally_map), c_uint, c_char_p_p]),
    ...
    ('wally_miniscript_to_script', c_int, [c_char_p, POINTER(wally_map), c_uint, c_uint, c_void_p, c_ulong, c_ulong_p]),
